...
public interface AdminMapper extends Mapper<Admin> {
    ...
    Admin checkAdmin(@Param("realName") String realName, @Param("ID") String ID, @Param("privilege") Integer privilege);

    Admin checkID(@Param("ID") String ID);

    Admin checkRealName(@Param("realName") String realName);
